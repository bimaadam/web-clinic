    ...
    <Container maxW={"7xl"} py={10}>
      ...
      <VStack gap={4} align="stretch">
        <Box bg="blue.100" p={5} borderRadius="md">
          ...
          <Text color={"gray.700"}>
            Pemeriksaan dan konsultasi dengan dokter umum & spesialis.
          </Text>
        </Box>
        <Box bg="green.100" p={5} borderRadius="md">
          ...
          <Text color={"gray.700"}>
            Cek darah, urine, dan pemeriksaan lainnya dengan hasil cepat.
          </Text>
        </Box>
        <Box bg="purple.100" p={5} borderRadius="md">
          ...
          <Text color={"gray.700"}>
            Vaksinasi untuk anak, dewasa, dan lansia sesuai kebutuhan.
          </Text>
        </Box>
        <Box bg="orange.100" p={5} borderRadius="md">
          ...
          <Text color={"gray.700"}>
            Layanan medis darurat 24 jam untuk kondisi mendesak.
          </Text>
        </Box>
      </VStack>
    </Container>
